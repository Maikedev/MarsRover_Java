...
public class Tela extends Canvas implements Runnable, KeyListener {
    ...
    public static void main(String[] args) throws Exception {
        ...
        obstaculos[0] = new Obstaculos(100, 200, 20, 20, "quadrado");
        obstaculos[1] = new Obstaculos(300, 150, 20, 20, "quadrado");
        obstaculos[2] = new Obstaculos(150, 200, 20, 20, "quadrado");
        obstaculos[3] = new Obstaculos(200, 250, 20, 20, "quadrado");
        ...
        obstaculos[7] = new Obstaculos(200, 350, 20, 20, "quadrado");
        obstaculos[8] = new Obstaculos(100, 50, 20, 20, "quadrado");
        obstaculos[9] = new Obstaculos(300, 50, 20, 20, "quadrado");
